...
export const chatWidget_toggle = () => {  // Not used, $zopim.livechat.window.getDisplay() not working correctly
  if (typeof window !== 'undefined' && typeof window.zE !== 'undefined' && typeof window.$zopim !== 'undefined') {
    zE(function () {
      $zopim(function () {
...
export const chatWidget_isConnected = () => {
  if (typeof window === 'undefined' || typeof window.zE === 'undefined'
    || typeof window.$zopim === 'undefined' || typeof window.$zopim.livechat === 'undefined'
  ) return  false
  else return true
}
