...
import { redirect } from '../../form-services'
      ...
      {formikProps => {
        ...
        return (
              <Form className="ownership-certifications">
                  {(applicationSubmitted || fileUploaded) &&
                    <Modal
                        buttonText='onboarding.browse'
                        handleClick={() => redirect('/settings/bank-accounts')}
                        subTitle='marketplace.WeAreVerifyingYourIdentity'
                        title='onboarding.congratulations'
                    >
                        <p><FormattedMessage id='marketplace.viewOnlyPopupText' /></p>
                    </Modal>
                  }
                  <StyledGrid>
                    <GridRow>
                    ...
                    <GridRow>
                        <GridColumn computer={8} tablet={8} mobile={16}>
                            ...
                            {fileName && <p style={{ margin: '.5rem 0' }}>{fileName}</p>}
                        </GridColumn>
                    </GridRow>
                    <GridRow>
                        <GridColumn>
