...
export const setupIndicatorSteps = [
  ...
  { type: 'step', text: 'onboarding.setup.indicator.beneficial.owners', step: 3 },
  { type: 'step', text: 'onboarding.setup.indicator.register.owners', step: 4, end: true },
...
export const setupIndicatorStepMobile = [
  {
      ...
      steps: [
          ...
          { type: 'step', text: 'onboarding.setup.indicator.control.person', step: 2, active: 2 }
      ],
  },
  {
      group: 1,
      ...
      steps: [
          { type: 'heading', text: 'onboarding.setup.indicator.ownership.verification' },
          { type: 'step', text: 'onboarding.setup.indicator.beneficial.owners', step: 0, active: 3 },
          { type: 'step', text: 'onboarding.setup.indicator.register.owners', step: 1, active: 4 }
      ]
  },
  {
      group: 2,
