...
export const setupIndicatorSteps = [
  ...
  { type: 'step', text: 'Register Owners', step: 4, end: true },
  ...
  { type: 'step', text: 'onboarding.setup.indicator.resale.certificates', step: 8 },
  { type: 'step', text: 'onboarding.setup.indicator.ownership.certifications', step: 9, end: true }
]
