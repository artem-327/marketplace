...
const getInitGenericProductId = store => getSafe(() => store.simpleAdd.initGenericProductId, null)
...
export const makeGetInitGenericProductId =() => createSelector([getInitGenericProductId], data => data)