...
class MyInventory extends Component {
  state = {
    columns: [
      ...
      { name: 'available', title: <FormattedMessage id='myInventory.available' defaultMessage='Available PKGs' />, width: 130, sortPath: 'ProductOffer.quantity' },
      { name: 'packaging', title: <FormattedMessage id='myInventory.packaging' defaultMessage='Packaging' />, width: 130, sortPath: 'ProductOffer.product.packagingType.name' },
      { name: 'pkgAmount', title: <FormattedMessage id='myInventory.pkgSize' defaultMessage='Pkg. Size' />, width: 130, sortPath: 'ProductOffer.pkgAmount' },
      { name: 'quantity', title: <FormattedMessage id='myInventory.quantity' defaultMessage='Quantity' />, width: 130 },
      { name: 'cost', title: <FormattedMessage id='myInventory.cost' defaultMessage='Cost' />, width: 100 },
      { name: 'fobPrice', title: <FormattedMessage id='myInventory.fobPrice' defaultMessage='FOB Price' />, width: 180, sortPath: 'ProductOffer.pricingPrice' },
      { name: 'manufacturer', title: <FormattedMessage id='myInventory.mfr' defaultMessage='MFR.' />, width: 220 },
      { name: 'lotNumber', title: <FormattedMessage id='myInventory.lot' defaultMessage='Lot #' />, width: 70 },
      { name: 'broadcast', title: <FormattedMessage id='myInventory.broadcast' defaultMessage='Broadcast' />, width: 130, align: 'right', sortPath: 'ProductOffer.broadcasted' },
