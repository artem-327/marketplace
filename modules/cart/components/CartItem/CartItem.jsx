      ...
      <GridStyled>
        <StyledGridRow padding='11px 0 7px'>
          <GridColumn largeScreen={8}>
            <CustomHeader data-test='cart_product_name_header'>{item.productOffer.companyProduct.companyGenericProduct.name}</CustomHeader>
          ...
          <GridColumn textAlign='right' largeScreen={8}>
            <DivIconsWrapper>
              <DivIconRectangle data-test='cart_product_remove_icon'>
                <IconTrash2
                  onClick={() =>
              ...
              <DivIconRectangle disabled={editDisabled} data-test='cart_product_edit_icon'>
