...
const DHS_RELEASE_SCREENING_THRESHOLD_Q_OPTIONS = ['1', '10', '100', '500', '1000', '2500', '5000', '10000', '15000', '20000', 'NA']
...
export const WEIGHT_UNIT_FILTER = [
  {
    key: 'epa',
...
export const COUNTRY_FILTER = [
    {
        key: 'Ukraine',
        text: <FormattedMessage id='global.test' defaultMessage='Ukraine' />,
        value: 'Ukraine'
    },
    {
        key: 'Unites State',
        text: <FormattedMessage id='global.test' defaultMessage='Unites State' />,
        value: 'Unites State'
    }
]
...
export const STATE_FILTER = [
    {
        key: 'test 1',
        text: <FormattedMessage id='global.test' defaultMessage='test 1' />,
        value: 'test 1'
    },
    {
        key: 'test 2',
        text: <FormattedMessage id='global.test' defaultMessage='test 2' />,
        value: 'test 2'
    }
]

export const CONDITION_FILTER = [
    {
        key: 'test 1',
        text: <FormattedMessage id='global.test' defaultMessage='test 1' />,
        value: 'test 1'
...
export const COUNTRY_OF_ORIGIN_FILTER = [
    {
        key: 'test 1',
        text: <FormattedMessage id='global.test' defaultMessage='test 1' />,
        value: 'test 1'
