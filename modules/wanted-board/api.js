...
export default {
  ...
  deleteWantedBoardBidsApi: id => api.delete(`/prodex/api/wanted-board-bids/id/${id}`).then(() => id),
  postNewWantedBoardBidsApi: value => api.post('/prodex/api/wanted-board-bids', value),
}
