    ...
    return (
      <>
        ...
        <RelaxedRow columns={2}>
          ...
          <GridColumn floated='right'>
            <FormattedNumber id='cart.packs' value={item.quantity * productOffer.product.packagingSize} /> {productOffer.product.packagingUnit.nameAbbreviation}
          </GridColumn>
        </RelaxedRow>
        ...
        <RelaxedRow columns={2}>
          <GridColumn>
            <FormattedMessage id='global.pricePer' values={{ unit: productOffer.product.packagingUnit.nameAbbreviation }} />
          </GridColumn>
        ...
        <HeaderTextRow columns={2}>
          ...
          <GridColumn floated='right'>
            <FormattedNumber style='currency' currency={currency} value={item.quantity * productOffer.product.packagingSize * productOffer.pricing.price.amount} />
          </GridColumn>
        </HeaderTextRow>
