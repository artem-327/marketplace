        ...
        <DivCenteredWrapper>
          ...
          <DivDescription>
            <FormattedMessage
              ...
              defaultMessage='For your security, we need some additional time to verify your identity and your financial information before you buy or sell on Blue Pallet Direct. You will only be able to view Blue Pallet Direct listings during this time. Most verifications are done within 24 hours but in rare cases can take up to 72 hours.'/>
          </DivDescription>
          <DivButtons>
            <DivButtonColumn>
              <Button
