...
const setup = (props = {}) => {
  ...
  return shallow(<AddEditCompanySidebar {...setupProps} />)
}
...
describe('`AddEditCompanySidebar` render component', () => {

  test('does not throw warning with expected props', () => {
    checkProps(AddEditCompanySidebar, defaultProps)
  })

  test('renders AddEditCompanySidebar component to be there', () => {
    const wrapper = setup()
