...
const getListDocumentTypes = state => getSafe(() => state.operations.listDocumentTypes, [])
const getDocumentTypesFetching = state => getSafe(() => state.operations.documentTypesFetching, false)
