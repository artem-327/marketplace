...
export const loadData = (endpointType, filter = null) => ({type: AT.ORDERS_FETCH_SUCCESS, payload: {endpointType, filter}})
...
export const cancelPayment = (orderId) => ({type: AT.ORDER_CANCEL_PAYMENT, async payload() {
