    ...
    return (
      <>
        <Modal closeIcon onClose={() => this.props.closePopup()} open={true} size='small'>
          ...
          <Modal.Header>
            <FormattedMessage id='order.someTextHeaderId' defaultMessage='PurchaseReviewCreditRequest header' />
          </Modal.Header>
          <ModalBody>
            <Modal.Description>
              <Form
                      ...
                      <Grid>
                        <Grid.Row>
                          <Grid.Column width={16}>
                            ...
                            <div>PurchaseReviewCreditRequest body</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(withToastManager(injectIntl(PurchaseReviewCreditRequest)))