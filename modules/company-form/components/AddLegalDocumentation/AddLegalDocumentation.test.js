...
//Components
import AddLegalDocumentation from './AddLegalDocumentation'
...
const setup = (props = {}) => {
  ...
  return shallow(<AddLegalDocumentation {...setupProps} />)
}
...
describe('`AddLegalDocumentation` render component', () => {

  test('does not throw warning with expected props', () => {
    checkProps(AddLegalDocumentation, defaultProps)
  })

  test('renders AddLegalDocumentation component to be there', () => {
    const wrapper = setup()
