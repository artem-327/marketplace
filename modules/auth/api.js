...
export const searchCountries = (searchQuery, returnWhenEmpty = true) => api.get(`/prodex/api/countries/search?pattern=${encodeURIComponent(searchQuery)}${returnWhenEmpty ? '&returnWhenEmpty=true' : ''}`)
