      ...
      return (
        <ProdexTable
          ...
          rows={datagrid.rows.map(r => ({
            ...
            expirationDate:
              r.expirationDate && moment(r.expirationDate).format('MM/DD/YYYY')
          }))}
                ...
                <GridRow>
                  ...
                  <GridColumn width={4}>
                    <Button
                      ...
                      <FormattedMessage
                        id='attachments.attachSelected'
                        defaultMessage='Attach Selected Files'>
                        {text => text}
                      </FormattedMessage>
                    </Button>
                  </GridColumn>
