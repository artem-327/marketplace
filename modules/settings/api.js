...
export default {
  ...
  deleteCSVMapEchoProduct: (mapId) =>
    api.delete(`/prodex/api/imports/echo-products/import-maps/${mapId}`),
  ...
  deleteCSVMapProductOffer: (mapId) =>
    api.delete(`/prodex/api/imports/product-offers/import-maps/${mapId}`),
