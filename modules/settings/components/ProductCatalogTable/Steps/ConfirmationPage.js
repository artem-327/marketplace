      ...
      <Grid centered padded>
        ...
        <Grid.Row>
          <StyledButton
            ...
            <FormattedMessage
              id={`settings.view${
                this.props.productOffer ? 'MyInventory' : 'Product'
              }`}
              defaultMessage={`View ${
                this.props.productOffer ? 'My Inventory' : 'Products'
              }`}
            />
          </StyledButton>
        </Grid.Row>
        <Grid.Row>
          <StyledButton
            primary
            onClick={this.props.toUpload}
            data-test='settings_product_to_upload'>
            <FormattedMessage
              id='settings.uploadMore'
