...
export default typeToReducer(
  {    
    ...
    [postNewProductName.fulfilled]: (state, {payload}) => {
      return {
        ...state,
        altCasNamesRows: payload,
        loading: false
    ...
    [updateProductName.fulfilled]: (state, {payload}) => {
      return {
        ...state,
        altCasNamesRows: payload,
        loading: false
    ...
    [deleteProductName.fulfilled]: (state, {payload}) => {
      return {
        ...state,
        altCasNamesRows: payload,
        loading: false
    ...
    [postNewCompanyGenericProductsAltName.rejected]: state => {
      return { 
        ...state,
        loading: false
      }
    },
    [postNewCompanyGenericProductsAltName.fulfilled]: (state, {payload}) => {
      return {
        ...state,
        altEchoNamesRows: payload,
        loading: false
    ...
    [updateCompanyGenericProductsAltName.pending]: state => {
      return { 
        ...state,
        loading: true
      }
    },
    [updateCompanyGenericProductsAltName.rejected]: state => {
      return { 
        ...state,
        loading: false
      }
    },
    [updateCompanyGenericProductsAltName.fulfilled]: (state, {payload}) => {
      return {
        ...state,
        altEchoNamesRows: payload,
        loading: false
    ...
    [deleteCompanyGenericProductsAltName.pending]: state => {
      return { 
        ...state,
        loading: true
      }
    },
    [deleteCompanyGenericProductsAltName.rejected]: state => {
      return { 
        ...state,
        loading: false
      }
    },
    [deleteCompanyGenericProductsAltName.fulfilled]: (state, {payload}) => {
      return {
        ...state,
        altEchoNamesRows: payload,
        loading: false
