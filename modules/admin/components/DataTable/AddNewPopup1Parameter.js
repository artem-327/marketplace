        ...
        <Modal.Content>
          ...
          >
            ...
            <div style={{ textAlign: 'right' }}>
              <Button.Reset data-test={`admin_add_${config.formattedMessageName}_cancel`} ><FormattedMessage id='global.cancel' defaultMessage='Cancel' /></Button.Reset>
              <Button.Submit data-test={`admin_add_${config.formattedMessageName}_save`}><FormattedMessage id='global.save' defaultMessage='Save' /></Button.Submit>
            </div>
          </Form>
        </Modal.Content>
      </Modal>
