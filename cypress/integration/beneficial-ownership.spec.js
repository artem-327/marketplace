...
describe('Benefical Ownership', () => {
  ...
  it('should send out an email to emailed beneficial owners', () => {
    ...
    cy.get('[data-test=beneficial_owner_emails_submit_btn]').click({ force: true })
  ...
  it('should move the user to the next module when they click "Yes"', () => {
    ...
    cy.get('[data-test=onboarding-module-title]').should('have.text', 'Owner Information')
  })
})
