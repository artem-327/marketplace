          ...
          ;(c = {
              ...
              dimmer: function() {
                ...
                j.fn.dimmer !== N
                  ? (c.debug('Creating dimmer'),
                    (o = b.dimmer(n)),
                    l.detachable
                      ? (c.verbose('Modal is detachable, moving content into dimmer'), o.dimmer('add content', v))
                      : c.set.undetached(),
            ...
            attachEvents: function(e, n) {
              ...
              ;(n = j.isFunction(c[n]) ? c[n] : c.toggle),
                0 < i.length
                  ? (c.debug('Attaching modal events to element', e, n), i.off(g).on('click' + g, n))
            ...
            hideAll: function(e) {
              ...
              ;(e = j.isFunction(e) ? e : function() {}),
                0 < n.length && (c.debug('Hiding all visible modals'), c.hideDimmer(), n.modal('hide modal', e))
            },
            hideOthers: function(e) {
              var n = t.filter('.' + u.active + ', .' + u.animating)
              ;(e = j.isFunction(e) ? e : function() {}),
                0 < n.length && (c.debug('Hiding other modals', t), n.modal('hide modal', e, !0))
            },
            others: {
              active: function() {
            ...
            set: {
              ...
              dimmerSettings: function() {
                if (j.fn.dimmer !== N) {
                  var e = {
                    ...
                    n = j.extend(!0, e, l.dimmerSettings)
                  l.inverted && (n.variation = n.variation !== N ? n.variation + ' inverted' : 'inverted'),
                    b.dimmer('setting', n)
              ...
              modalOffset: function() {
                var e = c.cache.width,
                  n = c.cache.height
                v.css({marginTop: l.centered && c.can.fit() ? -n / 2 : 0, marginLeft: -e / 2}),
            ...
            performance: {
              log: function(e) {
                ...
                l.performance &&
                  ...
                  (A = n),
                  O.push({Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: y, 'Execution Time': i})),
