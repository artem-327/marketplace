          ...
          ;(m = {
            ...
            show: function(e) {
              if (
                ...
                !m.can.show() &&
                  m.is.remote() &&
                  (m.debug('No API results retrieved, searching before show'), m.queryRemote(m.get.query(), m.show)),
            ...
            bind: {
              ...
              mouseEvents: function() {
                m.verbose('Binding mouse events'),
                  m.is.multiple() &&
                    S.on('click' + x, w.label, m.event.label.click).on('click' + x, w.remove, m.event.remove.click),
                  ...
                  m.is.multiple() && m.filterActive(),
                    ...
                    m.has.allResultsFiltered()
                      ? h.onNoResults.call(M, t)
                        ? h.allowAdditions
                          ? h.hideAdditions &&
                            (m.verbose('User addition with no menu, setting empty style'), m.set.empty(), m.hideMenu())
                          : (m.verbose('All items filtered, showing message', t), m.add.message(c.noResults))
            ...
            focusSearch: function(e) {
              m.has.search() &&
                ...
                (e
                  ? (S.off('focus' + x, w.search), T.focus(), S.on('focus' + x, w.search, m.event.search.focus))
                  : T.focus())
            },
            forceSelection: function() {
              ...
              if (0 < n.length && !m.is.multiple())
                return m.debug('Forcing partial selection to selected item', n), void m.event.item.click.call(n, {}, !0)
            ...
            change: {
              values: function(e) {
                h.allowAdditions || m.clear(),
                  ...
                  X.each(e, function(e, t) {
                    if (1 == t.selected)
                      return m.debug('Setting initial selection to', t.value), m.set.selected(t.value), !0
                  })
              }
            },
            event: {
              ...
              search: {
                ...
                blur: function(e) {
                  ;(t = G.activeElement === this),
                    m.is.searchSelection() && !i && (V || t || (h.forceSelection && m.forceSelection(), m.hide())),
                    (i = !1)
                }
              },
              icon: {
                ...
                if (m.is.inObject(t, p)) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      if (
                        ((n = d && c ? o.prevAll(w.item + ':not(' + w.unselectable + ')').eq(0) : R.eq(0)),
                        s.index(n) < 0)
                      )
                    ...
                    if (t == p.downArrow) {
                      if (
                        0 ===
                        (n = d && c ? (n = o.nextAll(w.item + ':not(' + w.unselectable + ')').eq(0)) : R.eq(0)).length
                      )
                    ...
                    f && e.preventDefault(),
                      t != p.downArrow ||
                        m.is.visible() ||
                        (m.verbose('Down key pressed, showing dropdown'), m.show(), e.preventDefault())
            ...
            get: {
              ...
              selectValues: function() {
                ...
                return (
                  ...
                  h.placeholder &&
                    'auto' !== h.placeholder &&
                    (m.debug('Setting placeholder value to', h.placeholder), (a.placeholder = h.placeholder)),
                  h.sortSelect
                    ...
                    R.each(function() {
                      ...
                      if (null !== n && n !== J)
                        if (o) (-1 === X.inArray(String(n), i) && -1 === X.inArray(t, i)) || (s = s ? s.add(e) : e)
                          ...
                          if ((m.verbose('Ambiguous dropdown value using strict type check', e, i), n === i || t === i))
                            return (s = e), !0
            ...
            restore: {
              ...
              defaultValue: function() {
                ...
                e !== J &&
                  ...
                  '' !== e ? (m.set.value(e), m.set.selected()) : (m.remove.activeItem(), m.remove.selectedItem()))
              },
              labels: function() {
                h.allowAdditions &&
              ...
              selected: function() {
                m.restore.values(),
                  m.is.multiple()
                    ? (m.debug('Restoring previously selected values and labels'), m.restore.labels())
            ...
            save: {
              ...
              placeholderText: function() {
                ...
                !1 !== h.placeholder &&
                  ...
                  ((e = m.get.text()), m.verbose('Saving placeholder text as', e), S.data(b.placeholderText, e))
              },
              remoteData: function(e, t) {
                Y.Storage !== J
                  ? (m.verbose('Saving remote data to session storage', t, e), sessionStorage.setItem(t, e))
                  : m.error(v.noStorage)
              }
            },
            clear: function() {
              m.is.multiple() && h.useLabels ? m.remove.labels() : (m.remove.activeItem(), m.remove.selectedItem()),
                m.set.placeholderText(),
                m.clearValue()
            },
            clearValue: function() {
              ...
              filtered: function() {
                ...
                e && a && (m.verbose('Adjusting input width', o, h.glyphWidth), T.css('width', o)),
                  a || (n && s)
                    ...
                    : (!e || (n && !s)) && (m.verbose('Showing placeholder text'), A.removeClass(g.filtered))
              },
              empty: function() {
                S.addClass(g.empty)
              },
              ...
              value: function(e, t, n) {
                ...
                if (a) {
                  if (
                    !h.allowReselection &&
                    s == o &&
                    (m.verbose('Skipping value update already same value', e, o), !m.is.initialLoad())
                  )
                    return
                  m.is.single() &&
                    m.has.selectInput() &&
            ...
            add: {
              ...
              optionValue: function(e) {
                ...
                0 < L.find('option[value="' + m.escape.string(t) + '"]').length ||
                  (m.disconnect.selectObserver(),
                  m.is.single() &&
                    (m.verbose('Removing previous user addition'), L.find('option.' + g.addition).remove()),
                  X('<option/>')
                    .prop('value', t)
                    .addClass(g.addition)
                    .html(e)
              ...
              value: function(e, t, n) {
                ...
                m.has.value(e)
                  ...
                  ? ((i = X.isArray(a) ? ((i = a.concat([e])), m.get.uniqueArray(i)) : [e]),
                    m.has.selectInput()
                      ? m.can.extendSelect() && (m.debug('Adding value to select', e, i, L), m.add.optionValue(e))
                      : ((i = i.join(h.delimiter)), m.debug('Setting hidden input to delimited value', i, L)),
                    !1 === h.fireOnInit && m.is.initialLoad()
                  ...
                  m.is.multiple()
                    ? h.useLabels
                      ...
                      : (m.remove.value(n, t, e),
                        0 === m.get.selectionCount() ? m.set.placeholderText() : m.set.text(m.add.variables(c.count)))
                    : m.remove.value(n, t, e),
                ...
                ;(e = e || S.find(w.label)),
                  ...
                  e.each(function() {
                    ...
                    !1 !== h.onLabelRemove.call(e, t)
                      ? (m.remove.message(), i ? (m.remove.value(n), m.remove.label(n)) : m.remove.selected(n))
              ...
              openDownward: function(e) {
                ...
                return (
                  ...
                  (a = (t = {
                    ...
                    below:
                      n.context.scrollTop + n.context.height >= n.menu.offset.top - n.context.offset.top + n.menu.height
                  }).below
            ...
            performance: {
              log: function(e) {
                ...
                h.performance &&
                  ...
                  (K = t),
                  W.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: M, 'Execution Time': n })),
