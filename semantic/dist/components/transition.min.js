          ...
          ;(m = {
                ...
                if (d.queue)
                  return (
                    !d.allowRepeats && m.has.direction() && m.is.occurring() && !0 !== m.queuing
                      ? m.debug('Animation is currently occurring, preventing queueing same animation', d.animation)
                      : m.queue(d.animation),
                    !1
                  )
                if (!d.allowRepeats && m.is.occurring())
                  return m.debug('Animation is already occurring, will not execute repeated animation', d.animation), !1
            ...
            get: {
              ...
              displayType: function(n) {
                return (
                  ...
                  d.displayType
                    ? d.displayType
                    : (n && f.data(i.displayType) === S && m.can.transition(!0), f.data(i.displayType))
                )
              },
            ...
            verbose: function() {
              !d.silent &&
                ...
                (d.performance
                  ? m.performance.log(arguments)
                  : ((m.verbose = Function.prototype.bind.call(console.info, console, d.name + ':')),
