      ...
      e.each(function() {
        ...
        ;(s = {
          ...
          read: {
            ...
            settings: function() {
              !1 !== r.total && (s.debug('Current total set in settings', r.total), s.set.total(r.total)),
                !1 !== r.value &&
                  (s.debug('Current value set in settings', r.value), s.set.value(r.value), s.set.progress(s.value)),
                !1 !== r.percent && (s.debug('Current percent set in settings', r.percent), s.set.percent(r.percent))
            }
          },
          bind: {
          ...
          set: {
            ...
            barLabel: function(e) {
              e !== T
                ...
                : 'percent' == r.label &&
                  (s.verbose('Adding percentage to bar label'), d.text(s.get.text(r.text.percent)))
            },
            active: function(e) {
              ;(e = e || r.text.active),
          ...
          performance: {
            log: function(e) {
              ...
              r.performance &&
                ...
                (x = t),
                w.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: v, 'Execution Time': n })),
