...
export default {
  ...
  getProductsCatalog: () => api.get('/prodex/api/products/search').then(response => response.data),
  getProductTypes: () => api.get('/prodex/api/packaging-types').then(response => response.data),
  ...
  postImportProductCSV: (body, id) => {
    return api
      .post(`/prodex/api/imports/csv-import-products?temporaryFileId=${id}`, body)
      .then(response => response.data)
  },
  postImportProductOfferCSV: (body, id) => {
    return api
      .post(`/prodex/api/imports/csv-import-product-offers?temporaryFileId=${id}`, body)
      .then(response => response.data)
  },
  postCSVMapProductOffer: data => api.post('/prodex/api/imports/product-offer-maps', data),
  uploadCSVFile: body => {
  ...
  patchUserRole: (id, body) => api.patch(`/prodex/api/users/id/${id}/add-roles`, body),
