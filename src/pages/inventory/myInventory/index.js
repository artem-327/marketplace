...
import {deleteProductOffersList, fetchMyProductOffers, deleteProductOffer, offerBroadcast} from '../../../modules/productOffers';
...
const mapDispatchToProps = dispatch => (
    bindActionCreators({fetchMyProductOffers, getCompanies, sendRules, deleteProductOffer, addPopup, removePopup, resetFilterTags, resetForm, deleteProductOffersList, offerBroadcast}, dispatch)
);
