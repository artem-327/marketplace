                        ...
                        <div className="mapped-form">
                            <div className="row header">
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <p className="title">
                                        {translate('inventoryPage.myInventory.mappedForm.mapped')}
                                    </p>
                                </div>
                            </div>
                            <div className="row body">
                                <div className="map-form-elem col-lg-6 col-md-6 col-sm-12">
                                    <MappedInput placeholder={translate('inventoryPage.myInventory.mappedForm.searchChemicalName')}/>
                                </div>
                                <div className="map-form-checkbox col-lg-4 col-md-4 col-sm-12">
                                    <input type="checkbox"/>
                                    <label>{translate('inventoryPage.myInventory.mappedForm.createMapping')}</label>
                                </div>
                                <div className="map-form-buttons col-lg-2 col-md-2 col-sm-12">
                                    <button className="filter-save-search">{ translate('inventoryPage.myInventory.mappedForm.saveRule') }
                                    </button>
