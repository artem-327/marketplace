...
export default class AddInventory extends Component {
  componentDidMount() {
    if (this.props.edit && this.props.productOffer) {
      this.props.dispatch(
        actions.merge('forms.productMapping', {
          casNumber:
            typeof this.props.productOffer.product !== 'undefined' ? this.props.productOffer.product.casNumber : '',
          chemicalName:
            typeof this.props.productOffer.product !== 'undefined' ? this.props.productOffer.product.chemicalName : '',
          indexName:
            typeof this.props.productOffer.product !== 'undefined' ? this.props.productOffer.product.casIndexName : '',
          packaging: {
            ...
            packagingType:
              ...
              this.props.productOffer.packaging.packagingType.measureType ===
                this.props.productOffer.packaging.unit.measureType
                ? this.props.productOffer.packaging.packagingType.id
                : '',
            unit:
              typeof this.props.productOffer.packaging !== 'undefined' ? this.props.productOffer.packaging.unit.id : 0
          }
        })
      )
      this.props.dispatch(
        actions.merge('forms.productOffering', {
          ...
          productGrade: this.props.productOffer.productGrades[0].id
        })
      )
      this.props.dispatch(
        actions.merge('forms.addProductOffer', {
  ...
  render() {
    ...
    return (
      <div>
        <h1 className='header'>
          {!this.props.edit ? (
            <FormattedMessage id='addInventory.addInventory' defaultMessage='ADD INVENTORY' />
          ) : (
            <FormattedMessage
