...
export default class ProductMapping extends Component {
  constructor(props) {
    ...
    this.state = {
      packagingType:
        props.productOffer.packaging && props.productOffer.packaging.unit.measureType
          ? props.productOffer.packaging.unit.measureType
          : null,
  ...
  selectedMeasurementUnit(value) {
    if (this.state && this.state.measurementType) return
  ...
  selectedPackagingUnit(value) {
    if (this.state && this.state.packagingType) return
  ...
  getMeasurementUnits() {
    ...
    if (!type) return this.props.unitOfMeasurement
  ...
  getPackagingUnits() {
    ...
    if (!type) return this.props.unitOfPackaging
  ...
  render() {
    let button = this.props.savedMapping ? (
      <button className='saved-productMapping'>
        <FormattedMessage id='addInventory.saved' defaultMessage='SAVED' />
      </button>
    ) : (
      <button id='mapping-btn' className='save-productMapping'>
        <FormattedMessage id='addInventory.saveMapping' defaultMessage='Save Mapping' />
      </button>
    )
    ...
    return (
      <div>
        <h4>
          <FormattedMessage id='addInventory.productMapping' defaultMessage='PRODUCT MAPPING' />
        </h4>
        <Form id='form-mapping' model='forms.productMapping' onSubmit={values => this.saveMapping(values)}>
          <div>
            <div className='group-item-wr'>
              <label htmlFor='.indexName'>
                <FormattedMessage id='addInventory.CasIndexName' defaultMessage='CAS Index Name' />
              </label>
              <Control.text model='.indexName' disabled={true} id='.indexName' defaultValue={''} />
            </div>
            <div className='group-item-wr'>
              <Errors
            ...
            <div className='group-item-wr'>
              <label htmlFor='.chemicalName'>
                <FormattedMessage id='addInventory.chemicalName' defaultMessage='Chemical Name' />
              </label>
              <Control.text model='.chemicalName' disabled={true} id='.chemicalName' defaultValue={''} />
            </div>
          </div>
          <div>
            <div className='group-item-wr'>
            ...
            <div className='group-item-wr'>
              <label htmlFor='.productCode'>
                <FormattedMessage id='addInventory.productCode' defaultMessage='Product Number' />
              </label>
              <Control.text
                model='.productCode'
                id='.productCode'
            ...
            <div className='group-item-wr'>
              ...
              <label htmlFor='.measurements'>
                <FormattedMessage id='addInventory.measure' defaultMessage='Measure' />
              </label>
              <Control.text
                model='.packaging.size'
            ...
            <div className='group-item-wr'>
              ...
              <label htmlFor='.productGrade'>
                <FormattedMessage id='addInventory.UM' defaultMessage='U/M' />
              </label>
              <DropdownRedux
            ...
            <div className='group-item-wr'>
              ...
              <label htmlFor='.productCondition'>
                <FormattedMessage id='addInventory.UP' defaultMessage='U/P' />
              </label>
              <DropdownRedux
                opns={this.getPackagingUnits()}
                placeholder='Select'
                model='forms.productMapping.packaging.packagingType'
                dispatch={this.props.dispatch}
                validators={{required}}
            ...
            {!this.props.edit ? (
              <React.Fragment>
                <Tooltip className='save-mapping' />
                {button}
              </React.Fragment>
            ) : null}
          </div>
