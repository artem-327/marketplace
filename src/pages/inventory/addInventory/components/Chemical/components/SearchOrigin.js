        ...
        return (
            <div>
                <div className='search-origin'>
                    ...
                    <input readonly={this.props.disable ? "readonly" : null} disabled={this.props.disable ? "disabled" : null} value={fulltext} onChange={(e) => this.handleChange(e)} placeholder='Search' ref={this.originRef}/>
                    {results}
                </div>
            </div>
        );
