...
export default class AddCart extends Component {
  ...
  render() {
    ...
    return (
      <Sidebar onHide={() => sidebarChanged({ isOpen: false })} width='very wide' className='cart-sidebar flex' direction='right' animation='scale down' visible={isOpen} style={{zIndex: 500}}>
        {
