            ...
            case MERCHANT: {
                ...
                return this.props.isFetching ? <Spinner/> :
                    <React.Fragment>
                        ...
                        {this.state.office ?
                            <React.Fragment>
                                <button className="button small" onClick={() => this.setState({approved: !this.state.approved})} data-test='administration_users_merchant_approve_btn'>{this.state.approved ? "Approved!" : "Approve"}</button>
                                <button className="button small green" onClick={()=>this.props.putPromoteToMerchant(this.props.id, {...user})} data-test='administration_users_merchant_save_btn'>Save</button>
                            </React.Fragment>
                        : null}
                    </React.Fragment>;
            }
            case OPERATOR: {
                ...
                return this.props.isFetching ? <Spinner/> :
                    <React.Fragment data-test='administration_users_login_inp'>
                        ...
                        {this.state.operator !== "" ? <button className="button small green" onClick={()=>this.props.putPromoteToOperator(this.props.id, {...user})} data-test='administration_users_operator_save_btn'>Save</button> : null}
                    </React.Fragment>;
            }
            default:
                return null
