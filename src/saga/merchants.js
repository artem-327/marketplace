...
import {
  MERCHANT_FETCH_REQUESTED,
  MERCHANT_FETCH_SUCCEEDED,
  MERCHANT_FETCH_FAILED,
  MERCHANT_EDIT_REQUESTED,
  MERCHANT_EDIT_SUCCEEDED,
  MERCHANT_EDIT_FAILED,
  MERCHANTS_FETCH_REQUESTED,
  MERCHANTS_FETCH_SUCCEEDED,
  MERCHANTS_FETCH_FAILED,
  MERCHANT_REMOVE_REQUESTED,
  MERCHANT_REMOVE_SUCCEEDED,
  MERCHANT_REMOVE_FAILED
} from '../constants/merchants'
import { REMOVE_POPUP } from '../constants/popup'
