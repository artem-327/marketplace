      ...
      <React.Fragment>
        <tr className='data-table-group-header' onClick={e => this.toggleGroup(e)} data-test='GroupRow_toggle_Group'>
          {this.props.selectable ? (
            <td className='data-table-select' ref={this.checkbox}>
              <Checkbox
          ...
          <td className='group-header' colSpan={this.props.headers.length + (this.props.contextMenu ? 2 : 0)}>
            {this.props.rows.group}
            <span className='data-table-group-count'>
              ...
              {this.state.open ? (
                <Icon name='chevron down' size='large' color='blue' />
              ) : (
                <Icon name='chevron right' size='large' color='blue' />
              )}
            </span>
          </td>
        </tr>
              ...
              if (this.props.rows.rows[opns.index]) {
                return (
                  <Row
                    ...
                    othersChecked={
                      !!this.props.rowsOpns.rows.filter((gr, indexGr) => {
