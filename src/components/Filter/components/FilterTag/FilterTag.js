  ...
  render() {
    ...
    return (
      <div className='filterTag'>
        <span>
          {this.checkName(this.props.name)}: {this.chooseFilter(this.props.name)}
        </span>
        <Icon
          name='times'
          onClick={() => {
            this.props.resetForm('forms.filter.' + this.props.name)
            this.props.close()
          }}
          data-test='FilterTag_filter_reset'
        />
      </div>
    )
  }
