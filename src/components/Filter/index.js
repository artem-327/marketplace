...
import {toggleFilterGroup, resetForm, addFilterTag} from '../../modules/filter';
...
function mapDispatchToProps(dispatch){
    return bindActionCreators({fetchPackageTypes, toggleFilterGroup, resetForm, addFilterTag}, dispatch)
}
